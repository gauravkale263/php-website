...
?>
  ...
  <main id="main">
    ...
    <?php
        $data=mysqli_query($conn,"SELECT * FROM about_us_data");
        $about_det=mysqli_fetch_assoc($data);
     ?>
    ...
    <section id="about" class="about">
      <div class="container" data-aos="fade-up">
        ...
        <div class="row position-relative">
          ...
          <div class="col-lg-7">
            <h2><?=$about_det['main_heading']?></h2>
            <div class="our-story">
              <h4><?=$about_det['heading_detail_year']?></h4>
              <h3>Our Story</h3>
              <p><?=$about_det['detail_heading']?></p>
              <!-- <ul>
              ...
              <div class="watch-video d-flex align-items-center position-relative">
                ...
                <a href="<?=$about_det['about_video_link']?>">Watch Video</a>
              </div>
            </div>
          </div>
